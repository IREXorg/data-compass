    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('languages', core.fields.ChoiceArrayField(base_field=models.CharField(choices=[('en', 'English'), ('sw', 'Swahili')], max_length=5), blank=True, default=list, help_text='By default, all surveys have an English version. If your survey will be in other languages, select or add them here. You will provide translations later.', size=None, verbose_name='languages')),
